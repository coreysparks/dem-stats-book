...
The `tidycensus` package had a great array of functions and the author Kyle Waker has published a book on using it \<FILL IN CITATION\> which covers its many uses.
...
[^macrodem-7]: Link to AHRF codebook - ["https://data.hrsa.gov/DataDownload/AHRF/AHRF_USER_TECH_2019-2020.zip"](https://data.hrsa.gov/DataDownload/AHRF/AHRF_USER_TECH_2019-2020.zip)

[^macrodem-8]: More on this below
