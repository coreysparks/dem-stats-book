...
The linear model is included in the base R `stats` package, and is accessed by the `lm()` function. There are many extensions to the linear model available in other packages the incorporate spatial, temporal and more complex modeling situations. 
