...
if the term $\sigma_{\epsilon}$ is not constant then the standard error of each parameter in the model is incorrect. Corrections for heteroskedasticity are commonplace in the social sciences, and are usually attributed to White [-@white_1980] and MacKinnon and White [-@mackinnon_white_1985] with many additions since the original publication, notably Long and Ervin [-@long_using_2000]. 
